...
The author would like to thank members of the ([GENEVA](http://www.genome.gov/27541319)) consortium (2017-2012) for access to the data used for testing the [gdsfmt](http://www.bioconductor.org/packages/gdsfmt) and [SNPRelate](http://www.bioconductor.org/packages/SNPRelate) packages.
